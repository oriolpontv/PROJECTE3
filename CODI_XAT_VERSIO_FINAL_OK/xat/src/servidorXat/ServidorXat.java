...
import servidorXat.Nomina;

public class ServidorXat extends JFrame {
	
	public class paraulesClient {
	...
	public ServidorXat() throws IOException{
        ...
        JButton btBackup = new JButton("LLEGIR XML");
        btBackup.setBackground(Color.decode("#C1271F"));
        ...
        btBackup.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            	...
            	System.out.println("LECTURA");try {
         		   
         		   System.out.println("TEST");
            		
                	JAXBContext context = JAXBContext.newInstance(Nomina.class);
            		Unmarshaller unmarshaller = context.createUnmarshaller();
            		Nomina nomina = (Nomina) unmarshaller.unmarshal(new File("D:\\2n DAM\\M9\\xat\\paraules_48057115H.xml"));
            		String paraula = nomina.getParaula(); 
	...
	static void llegirXML() {
		try {
    		
        	JAXBContext context = JAXBContext.newInstance(Nomina.class);
    		Unmarshaller unmarshaller = context.createUnmarshaller();
    		Nomina paraulesClient = (Nomina) unmarshaller.unmarshal(new File("D:\\2n DAM\\M9\\xat\\paraules_48057115H.xml"));
    		String paraula = paraulesClient.getParaula(); 
